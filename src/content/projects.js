  ...
  list: [
    {
      ...
      description: [
        '“繁星”是下一代网络游戏解决方案，它运用密码学、区块链的技术，让游戏玩家能够参与到独立网络游戏的部署、维护、反作弊之中，让开发者轻装上阵，像开发单机游戏一样简单地制作网络游戏，形成社区共建网络游戏的去中心化平台。主要解决的问题是：玩家怕开发者关闭网游服务，而开发者不胜部署、运维之烦；导致独立网络游戏明显少于独立单机游戏。',
        ...
        '宋甫负责此项目的团队管理、项目管理、专利技术设计、产品设计、示例游戏开发，以及对外事项。目前项目资金遇到问题，团队经过讨论，将谋求工作机会，待解决资金问题再继续研发。',
      ],
    },
    {
      title: '《Renaissance》',
