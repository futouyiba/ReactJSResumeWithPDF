...
const projects = {
  ...
  list: [
    {
      title: '《修勾夜店》',
      subtitle: '以 夜店&舞池 为题材的社交游戏',
      tags: [
        '元宇宙',
        '云蹦迪',
      ],
      description: [
        '《修勾夜店》以夜店为主题，主界面中，玩家可以在舞池里换装、跳舞、行为交互、聊天，也可以',
        '项目成功上线两次（iOS & Android市场全渠道）并进行推广，但推广结果是小孩用户太多，LTV和买量成本无法打平。目前壳已经更名为《不眠》。为什么上线两次？第一次上线结果我们通过内部方式得知有暗含的风险，随即重构了项目',
      ],
    },
    {
      title: '《云原生游戏项目》',
