...
const projects = {
  ...
  list: [
    ...
    },
    {
      ...
      description: [
        '<光与暗童话>可能是首款真正适合手机的Platformer游戏。有简化的操作、成熟的商业化体系。',
    ...
    },
    {
      ...
      description: [
        ...
        '宋甫在项目中担任主策划，制作了战斗原型、数值工具，主导了数值设计。',
      ],
    },
    {
      ...
      description: [
        ...
        '宋甫在项目中短暂担任主策划，彼时游戏已经上线。主要负责项目的公会战系统，从原型迭代到制作。',
      ],
    },
    {
    ...
    },
    {
      ...
      description: [
        ...
        '在《混沌与秩序2》中，宋甫力主将操作简化，将12个技能按钮缩减为4个，并通过武器技能、技能符文的搭配，赋予了更多的变化性。为此使用Lua脚本制作技能，迭代迅速。',
      ],
    },
  ],
};
