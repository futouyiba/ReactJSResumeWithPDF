  ...
  list: [
    {
      ...
      description: [
        ...
        '在项目中自己撰写了第一版设计案，并制作了第一版AIController+状态机（混合行为树）',
        '在项目中亲自制作了第一版AIController+状态机（混合行为树）',
        '离开原因：公司不做游戏了',
      ]
    },
    {
    ...
    },
    {
      ...
      description: [
        ...
        '除游戏的整体设计、具体设计之外，负责了游戏的战斗、网络同步部分代码编写',
        '制作了技能编辑器',
        '开发了实时联网布阵策略游戏《泉水指挥官》。',
      ],
    },
    {
      ...
      description: [
        '管理6人团队，原型迭代核心玩法，主导数值设计。',
        '制作了数值工具，能自动测试、统计平衡关系，能半自动生成次要属性。',
        '作为主创人员制作的《漫威：超级争霸战》（Marvel: Contest of Champions）全球收入超过5亿美元。《漫威：超级争霸战》是一款卡牌+格斗的高清3D游戏，核心战斗与外围系统都加入了大量的创新。',
        '作为主策短暂线上更新维护的《亚瑟英雄传》(Heroes of Camelot)是一款面向欧美的日式卡牌游戏，主要负责其中的公会战，从原型迭代到制作。',
      ],
    },
    {
      title: '数值策划组长',
